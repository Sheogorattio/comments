// FirstDeskApp.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "FirstDeskApp.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_FIRSTDESKAPP, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_FIRSTDESKAPP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FIRSTDESKAPP)); //////стандартная иконка
...
//
//
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)/////условный аналог мейна. вызывается самой системой
{
    switch (message)
    {
    case WM_COMMAND:
